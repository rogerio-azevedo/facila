...
export function ClientsPagination({ query, total }: ClientsPaginationProps) {
    ...
    <div className="flex items-center justify-end gap-6 px-2">
          ...
          onValueChange={(value) => {
            router.replace(
              buildClientsListHref({
                ...query,
                pageSize: Number(value) as ClientListQuery["pageSize"],
                page: 1,
              }),
            );
          }}
      ...
      <div className="flex items-center gap-2">
        ...
        >
          {canPrevious ? (
            <Link
              href={buildClientsListHref({ ...query, page: 1 })}
        ...
        >
          {canPrevious ? (
            <Link
              href={buildClientsListHref({ ...query, page: currentPage - 1 })}
        ...
        >
          {canNext ? (
            <Link
              href={buildClientsListHref({ ...query, page: totalPages })}
